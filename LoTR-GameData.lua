...
EVENTS = {
	...
	FramsOrks_Hope1 = {
		hope=true, value=11, title='evDiscardAllOrcs', effectTargets={trait='Ork'}, effect={id='leave'}, effectCondition={enemyInPlay={trait='Ork'}} },
	FramsRuins_Hope1 = {
		hope=true, value=4, title='evFindHiddenStair', targetPads={player='Sauron'}, effect={id='call',name='VersteckteTreppe',mustCall=true}, effectCondition={freeSauronSpaces=true} },
	FramsRuins_Threat1 = {
	...
	CampEttenmoors_Hope2 = {
		campaign=true, hope=true, value=7, title='evRandomCharProgress', effectTargets={ctype='Charakter'}, effect={id='progress',target='Zielvorgabe',randomTarget=true, targetCondition={minWillProgress=1}}, effectCondition={minObjectivesInPlay=1} },
	...
	BanditHunt_Threat = {
		value=38, title='evStrongerDangers', targetPads={player='Sauron'}, effect={id='addGroupEffect',permanent=true,target='Gefahr', effect={tr='Berechnung',id='bonus',w=2,code='Blockade',addCondition={ctype='Gefahr',maxLocation=2}}} },
	...
	CampIceplain_Hope2 = {
		...
		effectTargets={ctype='Diener'},eventCondition={maxBossesInPlay=0}, effect={id='damage',ignoreBlock=true,target='Gegner',randomTarget=true,excludeSource=true} },
	CampIceplain_Hope3 = {
