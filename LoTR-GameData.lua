...
-- used for random encounters and campaign: Name and number in deck, def num 1–10
	RANDOM_SETS = {
		...
		Drachenspuren = { Boss = { },
			Deck = { PanischeNatter=4, PanischerWolf=4, PanischesRudel=3, PanischerTroll=2, PanischerSchneebär=1, AusgehungerterFalke=4, Kaltdrachenjunges=3, JugendlicherKaltdrache=1, WolfdesTals=1, Winterwolf=2, BilwissimWolfspelz=2, EisigerWind=2, Schneesturm=2, VereisteVorräte=3, TieferSchnee=2, Gewitterblitze=2, Eisstacheln=1, GarstigesWetter=2, WenigVorräte=2, VerwehteSpuren=3, AufgescheuchteBestien=3, EisigerHauch=1 } },
		Jagdvorbereitungen = { Boss = { },
			Deck = { PanischerWolf=3, PanischesRudel=3, PanischerTroll=2, PanischerSchneebär=1, Kaltdrachenjunges=5, JugendlicherKaltdrache=5, Kreaturenhöhle=2, TieferSchnee=2, Gewitterblitze=2, VereisteVorräte=3, EisigerWind=2, Schneesturm=2, GarstigesWetter=2, VereisteArbeiten=3, EisigerHauch=2, AufgescheuchteBestien=3 } },
	...
	{	Name = 'campColdDrakeHunt', Zyklus = 'cyErebor',
		...
		Orte = {
			...
			{	Missionsname = 'missionColdDrakeHunt2', Missionsbild = 'https://i.imgur.com/llFjJpT.png',
				...
				Start = { OffenerHochkamm=1, EngerFelspass=1, AlteZwergenhalle=1, Winterwolf=2, Schneesturm=1, Kaltdrachenjunges={0,1,1,1}, Frostkugel={0,0,1,1} },
